                        ...
                        <div className="d-block">
                            <div className="list-group" role="button">
                                ...
                                <a href="#" className="skip-myaccount-link text-primary bg-white">
                                    Skip to navigation Security content
                                </a>
                                <Link
                                    className=" pt-3 pb-3  d-flex text-body align-items-center text-decoration-none pl-3 pr-3"
                                ...
                                <a
                                    ...
                                    href="/us/en/myaccount/rewardsandcredits"
                                >
                                    <svg
                                        stroke="currentColor"
                                        fill="currentColor"
                                ...
                                <a
                                    ...
                                    href="/us/en/myaccount/usermanagement"
                                >
                                    <svg
                                        stroke="currentColor"
                                        fill="currentColor"
                                ...
                                <a
                                    ...
                                    href="/us/en/myaccount/orderhistory"
                                >
                                    <svg
                                        stroke="currentColor"
                                        fill="currentColor"
                                ...
                                <a
                                    className=" pt-3 pb-3  d-flex text-body align-items-center text-decoration-none pl-3 pr-3"
                                    data-testid="qa-list"
                                    href="/us/en/myaccount/listsmanagement"
                                >
                                    <svg
                                        stroke="currentColor"
                                        fill="currentColor"
                                ...
                                <a
                                    ...
                                    href="/us/en/myaccount/directdeposit"
                                >
                                    <svg
                                        stroke="currentColor"
                                        fill="currentColor"
                                ...
                                <a
                                    ...
                                    href="/us/en/myaccount/favorites"
                                >
                                    <svg
                                        stroke="currentColor"
                                        fill="currentColor"
                                ...
                                <a
                                    ...
                                    href="/us/en/myaccount/subscriptions"
                                >
                                    <svg
                                        stroke="currentColor"
                                        fill="currentColor"
