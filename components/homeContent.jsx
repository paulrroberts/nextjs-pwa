...
export default function HomeContent() {
    return (
        <section id="id-app-wrapper" class="app-wrapper position-relative">
            <div class="home-page" no-gutters="true">
                <div class="position-relative w-100 hero-banner-section d-lg-flex px-0 container">
                    <div class="col-12 col-lg-7 p-0 hero-img-left" alt="">
                        <div class="">
                            <a class="link d-inline-block w-100" data-testid="hero-mainpanel" href="/us/en/catalog/mynd360">
                                <link
                                    rel="preload"
                                ...
                                />
                                <div
                                    class="w-100 pr-0 hero-banner-left d-md-flex align-items-center float-left position-relative"
                                    sx={{
                                        color: 'rgb(37, 37, 37)',
                                        background:
                                    ...
                                    aria-label=""
                                >
                                    <div class="mob-heroleft"></div>
                                    <div class="hero-banner-left-inner position-relative">
                                        <h2 class="heading-1">MYND360™</h2>
                                        <h3 class="heading-3">A holistic way to conquer a new day</h3>
                                        <div class="banner-left-text-color-black">
                                            <button type="button" class="hero-btn btn btn-primary">
                                                Shop Now
                                            </button>
                                        </div>
                                    </div>
                    ...
                    <div class="col-12 col-lg-5 p-0 hero-banner-right d-md-flex flex-lg-column float-left">
                        <div class="right-top-banner-container">
                            <div class="">
                                <a
                                    class="link d-inline-block w-100"
                                ...
                                >
                                    ...
                                    />
                                    <div
                                        class="w-100 hero-banner-right-inner one d-flex flex-column text-left justify-content-between"
                                        sx={{
                                            color: 'rgb(37, 37, 37)',
                                            background:
                                    ...
                                    >
                                        <p class="m-0">
                                            <span class="paragraph-m">ageLOC® Tru Face®</span>
                                        </p>
                                        <h2 class="heading-2 m-0">ageLOC® Tru Face® Peptide Retinol Complex</h2>
                                        <h3 class="h5-medium mb-10 paragraph-m m-0">is finally here!</h3>
                                        <div class="banner-right-text-color-black">
                                            <button sx={{ color: 'rgb(37, 37, 37)' }} type="button" class="text-left p-0 btn btn-link">
                                                <span class="paragraph-m">Shop Now</span>
                                            </button>
                                        </div>
                                    </div>
                                </a>
                        ...
                        <div class="right-bottom-banner-container">
                            <div class="">
                                <a class="link d-inline-block w-100" data-testid="hero-subpanel-2" href="/us/en/catalog/beauty_devices">
                                    <link
                                    ...
                                    />
                                    <div
                                        class="w-100 hero-banner-right-inner two d-flex flex-column text-left justify-content-between"
                                        sx={{
                                            color: 'rgb(37, 37, 37)',
                                            background:
                                    ...
                                    >
                                        <p class="m-0">
                                            <span class="paragraph-m"></span>
                                        </p>
                                        <h2 class="heading-2 m-0">It's official!</h2>
                                        <h3 class="h5-medium paragraph-m m-0">We're your go-to for devices.</h3>
                                        <div class="banner-right-text-color-black">
                                            <button sx={{ color: 'rgb(37, 37, 37)' }} type="button" class="text-left p-0 w-auto btn btn-link">
                                                <span class="paragraph-m">Shop Now</span>
                                            </button>
                                        </div>
                                    </div>
                ...
                <div class="mobile-title-section w-100 p-0 container-fluid">
                    <div sx={{ backgroundColor: 'rgb(245, 245, 245)' }} class="homepage-title row">
                        <div class="float-left homepage-title-left-img d-hide d-lg-show p-0 col-md-auto">
                ...
                <div class="separator-section w-100 p-0 container-fluid">
                    <div class="separator-container row">
                        <div class="hori-line"></div>
                        <h4 class="h4-bold subhead-l">DISCOVER OUR</h4>
                        <h3 class="heading-1">Most Popular Products</h3>
                    </div>
                </div>
                <div class="tabssection px-0 container-fluid">
                    <nav class="prodtabs heading-5 nav nav-tabs" role="tablist">
                        <a
                    ...
                    <div class="tab-content">
                        ...
                        >
                            <div class="popular-section " id="product-section">
                                <div></div>
                                <div class="container">
                                    <div class="popular-section-inner position-relative">
                                        <img
                                            src="https://www.nuskin.com/static/nu-home/assets/img/gray-cream.c348e4d7.png"
                                            alt="gray cream"
                                            class="product-image-bg-left"
                                        />
                                        <img
                                            src="https://www.nuskin.com/static/nu-home/assets/img/white-cream.5a4c116c.png"
                                            alt="white cream"
                                            class="product-image-bg-right"
                                        />
                                        <div class="pt-2 row">
                                            <div class="popular-section-left col-lg-5 col-md-6 col-sm-12">
                                                <div
                                                    class="popular-sidebar"
                                                    sx={{
                                                ...
                                                >
                                                    <div class="populat-text">
                                                        <h3 class="heading heading-1" sx={{ color: 'rgb(37, 37, 37)' }}>
                                                            The next big thing
                                                        </h3>
                                                        <div class="popular-text-color-black">
                                                            <a
                                                                class="link underline1 d-flex paragraph-m"
                                                                data-testid="link"
                                                                fonttoggle=""
                                            ...
                                            <div class="most-popular-slider col-lg-7 col-md-6 col-sm-12">
                                                <div class="viewmain">
                                                    <div class="">
                                                        <a class="link text-decoration-none d-inline-block" href="/us/en/catalog/all_new_and_loved">
                                                            <h6 class="viewsec paragraph-m">View All</h6>
                                                        </a>
                                                    </div>
                                                </div>
                                                <div>
                                                    <div class="slider-arrow">
                                                        <div class="arrow-btn prev">
                                                            <button
                                                                ...
                                                                type="button"
                                                                class="undefined icon btn btn-primary"
                                                            >
                                                                <svg
                                                                    data-v-36192c72=""
                                                                    data-v-7c6384a4=""
                                                    ...
                                                    <div class="slick-slider slick-initialized" dir="ltr">
                                                        <div class="slick-list">
                                                            ...
                                                            >
                                                                ...
                                                                >
                                                                    <div>
                                                                        <div tabIndex="-1" sx={{ width: '100%', display: 'inline-block' }} class="card">
                                                                            <div class="card-body">
                                                                                <div class="">
                                                                                    <a
                                                                                    ...
                                                                                    >
                                                                                        <div class="product_image">
                                                                                            <div
                                                                                                class="image-wrapper col-12 p-0 m-0 "
                                                                                        ...
                                                                                        <div class="card-title h5">
                                                                                            <h2 class="heading-3-bold limit-title-height">
                                                                                                Pharmanex® Nu Biome®
                                                                                            </h2>
                                                                                        </div>
                                                                                        <p class="card-text">
                                                                                            <span class="content paragraph-m-bold d-block">$80.00</span>
                                                                                        </p>
                                                                                        <button
                                                                                            type="button"
                                                                                            class="pop-add-btn d-flex cta text-uppercase btn btn-primary"
                                                                                        >
                                                                                            <svg
                                                                                                stroke="currentColor"
                                                                                                fill="currentColor"
                                                                            ...
                                                                            <div class="card-body">
                                                                                <div class="">
                                                                                    ...
                                                                                    >
                                                                                        ...
                                                                                        <p class="card-text">
                                                                                            <span class="content paragraph-m-bold d-block">$40.00</span>
                                                                                        </p>
                                                                                        <button
                                                                                            type="button"
                                                                                            class="pop-add-btn d-flex cta text-uppercase btn btn-primary"
                                                                            ...
                                                                            <div class="card-body">
                                                                                <div class="">
                                                                                    ...
                                                                                    >
                                                                                        ...
                                                                                        <p class="card-text">
                                                                                            <span class="content paragraph-m-bold d-block">$161.00</span>
                                                                                        </p>
                                                                                        <button
                                                                                            type="button"
                                                                                            class="pop-add-btn d-flex cta text-uppercase btn btn-primary"
                                                                            ...
                                                                            <div class="card-body">
                                                                                <div class="">
                                                                                    ...
                                                                                    >
                                                                                        ...
                                                                                        <p class="card-text">
                                                                                            <span class="content paragraph-m-bold d-block">$19.00</span>
                                                                                        </p>
                                                                                        <button
                                                                                            type="button"
                                                                                            class="pop-add-btn d-flex cta text-uppercase btn btn-primary"
                                                                            ...
                                                                            <div class="card-body">
                                                                                <div class="">
                                                                                    ...
                                                                                    >
                                                                                        ...
                                                                                        <p class="card-text">
                                                                                            <span class="content paragraph-m-bold d-block">$57.00</span>
                                                                                        </p>
                                                                                        <button
                                                                                            type="button"
                                                                                            class="pop-add-btn d-flex cta text-uppercase btn btn-primary"
                                                                            ...
                                                                            <div class="card-body">
                                                                                <div class="">
                                                                                    ...
                                                                                    >
                                                                                        ...
                                                                                        <div class="card-title h5">
                                                                                            <h2 class="heading-3-bold limit-title-height">Renu Hair Mask</h2>
                                                                                        </div>
                                                                                        <p class="card-text">
                                                                                            <span class="content paragraph-m-bold d-block">$31.00</span>
                                                                                        </p>
                                                                                        <button
                                                                                            type="button"
                                                                                            class="pop-add-btn d-flex cta text-uppercase btn btn-primary"
                                ...
                                <div class="container">
                                    <div class="popular-section-inner position-relative">
                                        ...
                                        <div class="pt-2 row">
                                            ...
                                            <div class="most-popular-slider col-lg-7 col-md-6 col-sm-12">
                                                <div>
                                                    <div class="mpp-placeholder">
                                                        <div class="mb-2 col-lg-6 col-md-1">
                ...
                <div class="category-head justify-content-center mx-0 row">
                    <h3 class="heading-1 mb-0 mt-5">Our Top Categories</h3>
                </div>
                <div id="our-top-categories" class="category-section-slider-wrapper row">
                    <div class="viewmain d-none d-md-block px-0 mx-0 col-md-auto">
                        <div class="">
                            <a class="link text-decoration-none" href="/us/en/categoryLanding/skin_and_beauty">
                                <h6 class="viewsec paragraph-m">View All</h6>
                            </a>
                        </div>
                    </div>
                    <div>
                        <div class="slider-arrow">
                            <div class="arrow-btn prev">
                                <button aria-label="Previous Image" data-testid="qa-pdp-left-arrow" type="button" class="undefined icon btn btn-primary">
                                    <svg
                                        data-v-36192c72=""
                                        data-v-7c6384a4=""
                                        viewBox="0 0 24 24"
                            ...
                            <div class="arrow-btn next">
                                <button aria-label="Next Image" data-testid="qa-pdp-right-arrow" type="button" class="undefined icon btn btn-primary">
                                    <svg
                                        data-v-36192c72=""
                                        data-v-7c6384a4=""
                                        viewBox="0 0 24 24"
                    ...
                    <div>
                        <div class="slick-slider category-selection slick-initialized" dir="ltr">
                            <div class="slick-list">
                                <div class="slick-track" sx={{ width: '6525px', opacity: 1, transform: 'translate3d(-1305px, 0px, 0px)' }}>
                                    <div data-index="-5" tabIndex="-1" class="slick-slide slick-cloned" aria-hidden="true" sx={{ width: '261px' }}>
                                        <div>
                                            <div tabIndex="-1" sx={{ width: '100%', display: 'inline-block' }} class="homepage category-section-card card">
                                                <div class="">
                                                    <a class="link text-decoration-none" href="/us/en/catalog/oral_care">
                                                        <div class="image-wrapper col-12 p-0 m-0 " sx={{ width: '230px', height: '260px' }}>
                                                            <img
                                                        ...
                                                        <div class="card-body">
                                                            <div class="head-3 heading-3 card-subtitle h6">Oral Care</div>
                                                        </div>
                                                    </a>
                                                </div>
                                            </div>
                                    ...
                                    <div data-index="-4" tabIndex="-1" class="slick-slide slick-cloned" aria-hidden="true" sx={{ width: '261px' }}>
                                        <div>
                                            <div tabIndex="-1" sx={{ width: '100%', display: 'inline-block' }} class="homepage category-section-card card">
                                                <div class="">
                                                    <a class="link text-decoration-none" href="/us/en/catalog/body" tabIndex="-1">
                                                        <div class="image-wrapper col-12 p-0 m-0 " sx={{ width: '230px', height: '260px' }}>
                                                            <img
                                                        ...
                                                        <div class="card-body">
                                                            <div class="head-3 heading-3 card-subtitle h6">Body Care</div>
                                                        </div>
                                                    </a>
                                                </div>
                                            </div>
                                    ...
                                    <div data-index="-3" tabIndex="-1" class="slick-slide slick-cloned" aria-hidden="true" sx={{ width: '261px' }}>
                                        <div>
                                            <div tabIndex="-1" sx={{ width: '100%', display: 'inline-block' }} class="homepage category-section-card card">
                                                <div class="">
                                                    <a class="link text-decoration-none" href="/us/en/catalog/makeup" tabIndex="-1">
                                                        <div class="image-wrapper col-12 p-0 m-0 " sx={{ width: '230px', height: '260px' }}>
                                                            <img
                                                        ...
                                                        <div class="card-body">
                                                            <div class="head-3 heading-3 card-subtitle h6">Makeup </div>
                                                        </div>
                                                    </a>
                                                </div>
                                            </div>
                                    ...
                                    <div data-index="-2" tabIndex="-1" class="slick-slide slick-cloned" aria-hidden="true" sx={{ width: '261px' }}>
                                        <div>
                                            <div tabIndex="-1" sx={{ width: '100%', display: 'inline-block' }} class="homepage category-section-card card">
                                                <div class="">
                                                    <a class="link text-decoration-none" href="/us/en/catalog/facial_moisturizers" tabIndex="-1">
                                                        <div class="image-wrapper col-12 p-0 m-0 " sx={{ width: '230px', height: '260px' }}>
                                                            <img
                                                        ...
                                                        <div class="card-body">
                                                            <div class="head-3 heading-3 card-subtitle h6">Facial Moisturizers</div>
                                                        </div>
                                                    </a>
                                                </div>
                                            </div>
                                    ...
                                    <div data-index="-1" tabIndex="-1" class="slick-slide slick-cloned" aria-hidden="true" sx={{ width: '261px' }}>
                                        <div>
                                            <div tabIndex="-1" sx={{ width: '100%', display: 'inline-block' }} class="homepage category-section-card card">
                                                <div class="">
                                                    <a class="link text-decoration-none" href="/us/en/catalog/hair_care" tabIndex="-1">
                                                        <div class="image-wrapper col-12 p-0 m-0 " sx={{ width: '230px', height: '260px' }}>
                                                            <img
                                                        ...
                                                        <div class="card-body">
                                                            <div class="head-3 heading-3 card-subtitle h6">Hair Care</div>
                                                        </div>
                                                    </a>
                                                </div>
                                            </div>
                                    ...
                                    >
                                        <div>
                                            <div tabIndex="-1" sx={{ width: '100%', display: 'inline-block' }} class="homepage category-section-card card">
                                                <div class="">
                                                    <a class="link text-decoration-none" href="/us/en/catalog/beauty_devices">
                                                        <div class="image-wrapper col-12 p-0 m-0 " sx={{ width: '230px', height: '260px' }}>
                                                            <img
                                                        ...
                                                        <div class="card-body">
                                                            <div class="head-3 heading-3 card-subtitle h6">Beauty Devices</div>
                                                        </div>
                                                    </a>
                                                </div>
                                            </div>
                                    ...
                                    >
                                        <div>
                                            <div tabIndex="-1" sx={{ width: '100%', display: 'inline-block' }} class="homepage category-section-card card">
                                                <div class="">
                                                    <a class="link text-decoration-none" href="/us/en/catalog/multi_vitamins">
                                                        <div class="image-wrapper col-12 p-0 m-0 " sx={{ width: '230px', height: '260px' }}>
                                                            <img
                                                        ...
                                                        <div class="card-body">
                                                            <div class="head-3 heading-3 card-subtitle h6">Multivitamins</div>
                                                        </div>
                                                    </a>
                                                </div>
                                            </div>
                                    ...
                                    >
                                        <div>
                                            <div tabIndex="-1" sx={{ width: '100%', display: 'inline-block' }} class="homepage category-section-card card">
                                                <div class="">
                                                    <a class="link text-decoration-none" href="/us/en/catalog/anti-aging">
                                                        <div class="image-wrapper col-12 p-0 m-0 " sx={{ width: '230px', height: '260px' }}>
                                                            <img
                                                        ...
                                                        <div class="card-body">
                                                            <div class="head-3 heading-3 card-subtitle h6">Anti-aging</div>
                                                        </div>
                                                    </a>
                                                </div>
                                            </div>
                                    ...
                                    >
                                        <div>
                                            <div tabIndex="-1" sx={{ width: '100%', display: 'inline-block' }} class="homepage category-section-card card">
                                                <div class="">
                                                    <a class="link text-decoration-none" href="/us/en/catalog/targeted_wellness">
                                                        <div class="image-wrapper col-12 p-0 m-0 " sx={{ width: '230px', height: '260px' }}>
                                                            <img
                                                        ...
                                                        <div class="card-body">
                                                            <div class="head-3 heading-3 card-subtitle h6">Targeted Wellness</div>
                                                        </div>
                                                    </a>
                                                </div>
                                            </div>
                                    ...
                                    >
                                        <div>
                                            <div tabIndex="-1" sx={{ width: '100%', display: 'inline-block' }} class="homepage category-section-card card">
                                                <div class="">
                                                    <a class="link text-decoration-none" href="/us/en/catalog/facial_cleansers">
                                                        <div class="image-wrapper col-12 p-0 m-0 " sx={{ width: '230px', height: '260px' }}>
                                                            <img
                                                        ...
                                                        <div class="card-body">
                                                            <div class="head-3 heading-3 card-subtitle h6">Facial Cleansers</div>
                                                        </div>
                                                    </a>
                                                </div>
                                            </div>
                                    ...
                                    <div data-index="5" class="slick-slide" tabIndex="-1" aria-hidden="true" sx={{ outline: 'none', width: '261px' }}>
                                        <div>
                                            <div tabIndex="-1" sx={{ width: '100%', display: 'inline-block' }} class="homepage category-section-card card">
                                                <div class="">
                                                    <a class="link text-decoration-none" href="/us/en/catalog/oral_care" tabIndex="-1">
                                                        <div class="image-wrapper col-12 p-0 m-0 " sx={{ width: '230px', height: '260px' }}>
                                                            <img
                                                                src="https://media.nuskin.com/m/fab54a8c9cf2474/Small-category-oral_care.jpg"
                                                                data-src="https://media.nuskin.com/m/fab54a8c9cf2474/Small-category-oral_care.jpg"
                                    ...
                                    <div data-index="6" class="slick-slide" tabIndex="-1" aria-hidden="true" sx={{ outline: 'none', width: '261px' }}>
                                        <div>
                                            <div tabIndex="-1" sx={{ width: '100%', display: 'inline-block' }} class="homepage category-section-card card">
                                                <div class="">
                                                    <a class="link text-decoration-none" href="/us/en/catalog/body" tabIndex="-1">
                                    ...
                                    <div data-index="7" class="slick-slide" tabIndex="-1" aria-hidden="true" sx={{ outline: 'none', width: '261px' }}>
                                        <div>
                                            <div tabIndex="-1" sx={{ width: '100%', display: 'inline-block' }} class="homepage category-section-card card">
                                                <div class="">
                                                    <a class="link text-decoration-none" href="/us/en/catalog/makeup" tabIndex="-1">
                                    ...
                                    <div data-index="8" class="slick-slide" tabIndex="-1" aria-hidden="true" sx={{ outline: 'none', width: '261px' }}>
                                        <div>
                                            <div tabIndex="-1" sx={{ width: '100%', display: 'inline-block' }} class="homepage category-section-card card">
                                                <div class="">
                                                    <a class="link text-decoration-none" href="/us/en/catalog/facial_moisturizers" tabIndex="-1">
                                    ...
                                    <div data-index="9" class="slick-slide" tabIndex="-1" aria-hidden="true" sx={{ outline: 'none', width: '261px' }}>
                                        <div>
                                            <div tabIndex="-1" sx={{ width: '100%', display: 'inline-block' }} class="homepage category-section-card card">
                                                <div class="">
                                                    <a class="link text-decoration-none" href="/us/en/catalog/hair_care" tabIndex="-1">
                                    ...
                                    <div data-index="10" tabIndex="-1" class="slick-slide slick-cloned" aria-hidden="true" sx={{ width: '261px' }}>
                                        <div>
                                            <div tabIndex="-1" sx={{ width: '100%', display: 'inline-block' }} class="homepage category-section-card card">
                                                <div class="">
                                                    <a class="link text-decoration-none" href="/us/en/catalog/beauty_devices" tabIndex="-1">
                                                        <div class="image-wrapper col-12 p-0 m-0 " sx={{ width: '230px', height: '260px' }}>
                                                            <img
                                                                src="https://media.nuskin.com/m/7e772753b91e94c3/Small-category-beauty_devices.jpg"
                                                                data-src="https://media.nuskin.com/m/7e772753b91e94c3/Small-category-beauty_devices.jpg"
                                    ...
                                    <div data-index="11" tabIndex="-1" class="slick-slide slick-cloned" aria-hidden="true" sx={{ width: '261px' }}>
                                        <div>
                                            <div tabIndex="-1" sx={{ width: '100%', display: 'inline-block' }} class="homepage category-section-card card">
                                                <div class="">
                                                    <a class="link text-decoration-none" href="/us/en/catalog/multi_vitamins" tabIndex="-1">
                                                        <div class="image-wrapper col-12 p-0 m-0 " sx={{ width: '230px', height: '260px' }}>
                                                            <img
                                                                src="https://media.nuskin.com/m/5ae685e26f2b276a/Small-category-multivitamins.jpg"
                                                                data-src="https://media.nuskin.com/m/5ae685e26f2b276a/Small-category-multivitamins.jpg"
                                    ...
                                    <div data-index="12" tabIndex="-1" class="slick-slide slick-cloned" aria-hidden="true" sx={{ width: '261px' }}>
                                        <div>
                                            <div tabIndex="-1" sx={{ width: '100%', display: 'inline-block' }} class="homepage category-section-card card">
                                                <div class="">
                                                    <a class="link text-decoration-none" href="/us/en/catalog/anti-aging" tabIndex="-1">
                                                        <div class="image-wrapper col-12 p-0 m-0 " sx={{ width: '230px', height: '260px' }}>
                                                            <img
                                                                src="https://media.nuskin.com/m/46a91d9030549acb/Small-category-anti_aging.jpg"
                                                                data-src="https://media.nuskin.com/m/46a91d9030549acb/Small-category-anti_aging.jpg"
                                    ...
                                    <div data-index="13" tabIndex="-1" class="slick-slide slick-cloned" aria-hidden="true" sx={{ width: '261px' }}>
                                        <div>
                                            <div tabIndex="-1" sx={{ width: '100%', display: 'inline-block' }} class="homepage category-section-card card">
                                                <div class="">
                                                    <a class="link text-decoration-none" href="/us/en/catalog/targeted_wellness" tabIndex="-1">
                                                        <div class="image-wrapper col-12 p-0 m-0 " sx={{ width: '230px', height: '260px' }}>
                                                            <img
                                                                src="https://media.nuskin.com/m/43242a7f2ca249ad/Small-category-targeted_wellness.jpg"
                                                                data-src="https://media.nuskin.com/m/43242a7f2ca249ad/Small-category-targeted_wellness.jpg"
                                    ...
                                    <div data-index="14" tabIndex="-1" class="slick-slide slick-cloned" aria-hidden="true" sx={{ width: '261px' }}>
                                        <div>
                                            <div tabIndex="-1" sx={{ width: '100%', display: 'inline-block' }} class="homepage category-section-card card">
                                                <div class="">
                                                    <a class="link text-decoration-none" href="/us/en/catalog/facial_cleansers" tabIndex="-1">
                                                        <div class="image-wrapper col-12 p-0 m-0 " sx={{ width: '230px', height: '260px' }}>
                                                            <img
                                                                src="https://media.nuskin.com/m/36f2a073f3de08a2/Small-category-facial_cleansers.jpg"
                                                                data-src="https://media.nuskin.com/m/36f2a073f3de08a2/Small-category-facial_cleansers.jpg"
                                    ...
                                    <div data-index="15" tabIndex="-1" class="slick-slide slick-cloned" aria-hidden="true" sx={{ width: '261px' }}>
                                        <div>
                                            <div tabIndex="-1" sx={{ width: '100%', display: 'inline-block' }} class="homepage category-section-card card">
                                                <div class="">
                                                    <a class="link text-decoration-none" href="/us/en/catalog/oral_care" tabIndex="-1">
                                    ...
                                    <div data-index="16" tabIndex="-1" class="slick-slide slick-cloned" aria-hidden="true" sx={{ width: '261px' }}>
                                        <div>
                                            <div tabIndex="-1" sx={{ width: '100%', display: 'inline-block' }} class="homepage category-section-card card">
                                                <div class="">
                                                    <a class="link text-decoration-none" href="/us/en/catalog/body" tabIndex="-1">
                                    ...
                                    <div data-index="17" tabIndex="-1" class="slick-slide slick-cloned" aria-hidden="true" sx={{ width: '261px' }}>
                                        <div>
                                            <div tabIndex="-1" sx={{ width: '100%', display: 'inline-block' }} class="homepage category-section-card card">
                                                <div class="">
                                                    <a class="link text-decoration-none" href="/us/en/catalog/makeup" tabIndex="-1">
                                    ...
                                    <div data-index="18" tabIndex="-1" class="slick-slide slick-cloned" aria-hidden="true" sx={{ width: '261px' }}>
                                        <div>
                                            <div tabIndex="-1" sx={{ width: '100%', display: 'inline-block' }} class="homepage category-section-card card">
                                                <div class="">
                                                    <a class="link text-decoration-none" href="/us/en/catalog/facial_moisturizers" tabIndex="-1">
                                    ...
                                    <div data-index="19" tabIndex="-1" class="slick-slide slick-cloned" aria-hidden="true" sx={{ width: '261px' }}>
                                        <div>
                                            <div tabIndex="-1" sx={{ width: '100%', display: 'inline-block' }} class="homepage category-section-card card">
                                                <div class="">
                                                    <a class="link text-decoration-none" href="/us/en/catalog/hair_care" tabIndex="-1">
                    ...
                    <div class="mob-view-all d-block d-md-none px-0 col">
                        <div class="">
                            <a class="link text-decoration-none" href="/us/en/categoryLanding/skin_and_beauty">
                                <h6 class="viewsec m-0 cta">View All</h6>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="features-section position-relative w-100 d-flex flex-column px-0 container">
                    <div class="features-new position-relative w-100 d-inline-block mx-auto row">
                        <div
                            sx={{ background: 'rgb(239, 229, 215)' }}
                            class="features-new-kit position-relative d-flex flex-column flex-wrap align-items-start align-items-md-center justify-content-start justify-content-lg-center row"
                        >
                            <div class="features-inner-text col">
                                <h6 class="paragraph-s ">RenuSpa iO™</h6>
                                <h3 class="heading-1">Get ready to reclaim whole-body wellness</h3>
                                <h4 class="paragraph-l">One personalized wellness and beauty device to restore, revitalize, and refresh.</h4>
                                <div class="">
                                    <a
                                        href="https://www.nuskin.com/content/nuskin/en_US/renuspa-io-beauty-market-introduction.html"
                                        class="link cta text-uppercase"
                                        target="_self"
                                    >
                                        <strong>Discover Now</strong>
                                    </a>
                                </div>
                                <div md="auto" class="features-bottom-image d-none d-md-block px-0">
                                    <div class="image-wrapper col-12 p-0 m-0 " sx={{ width: 'auto', height: 'auto' }}>
                                        <img
                        ...
                        <div class="features-new-kit-image px-0 row">
                            <div class="image-wrapper col-12 p-0 m-0 " sx={{ width: 'auto', height: 'auto' }}>
                                <img
                            ...
                            <div class="features-bottom-image d-block d-md-none px-0 col">
                                <div class="image-wrapper col-12 p-0 m-0 " sx={{ width: 'auto', height: 'auto' }}>
                                    <img
                                        src="https://media.nuskin.com/transform/59f93461-9141-4275-bd3c-be7829d4a851/nu-skin-renuspa-io-showcase-accent-image"
                                        data-src="https://media.nuskin.com/transform/59f93461-9141-4275-bd3c-be7829d4a851/nu-skin-renuspa-io-showcase-accent-image"
                ...
                <div class="separator-section w-100 p-0 container-fluid">
                    <div class="separator-container row">
                        <div class="hori-line"></div>
                        <h4 class="h4-bold subhead-l">OUR COLLECTION</h4>
                        <h3 class="heading-1">Explore Some Of Our Brands</h3>
                    </div>
                </div>
                <div id="brandsec" class="brandsec d-block row">
                    <div class="viewmain d-none d-md-block px-0 col-md-auto">
                        <div class="">
                            <a class="link text-decoration-none" href="/us/en/categoryLanding/skin_and_beauty">
                                <h6 class="viewsec paragraph-m">View All</h6>
                            </a>
                    ...
                    <div>
                        <div class="slick-slider pb-3 slick-initialized" dir="ltr">
                            <div class="slick-list">
                                <div class="slick-track" sx={{ width: '6525px', opacity: 1, transform: 'translate3d(-1305px, 0px, 0px)' }}>
                                    <div data-index="-5" tabIndex="-1" class="slick-slide slick-cloned" aria-hidden="true" sx={{ width: '261px' }}>
                                        <div>
                                            <div tabIndex="-1" sx={{ width: '100%', display: 'inline-block' }} class="brandsection card">
                                                <div class="">
                                                    <a class="link text-decoration-none" href="/us/en/catalog/nutricentials">
                                                        <div class="brand-image">
                                                            <div class="image-wrapper col-12 p-0 m-0 " sx={{ width: 'auto', height: '260px' }}>
                                                                <img
                                                                    ...
                                                                    width="auto"
                                                                    title="Nutricentials"
                                                                    class="position-relative brand-img"
                                                                    aria-label=""
                                                                    data-alt-text-resolution="cs"
                                                                />
                                                            </div>
                                                        ...
                                                        <div class="p-0 w-100 brand-sec-body card-body">
                                                            <div class="head-3 heading-3 card-subtitle h6">Nutricentials</div>
                                                        </div>
                                                    </a>
                                                </div>
                                            </div>
                                    ...
                                    <div data-index="-4" tabIndex="-1" class="slick-slide slick-cloned" aria-hidden="true" sx={{ width: '261px' }}>
                                        <div>
                                            <div tabIndex="-1" sx={{ width: '100%', display: 'inline-block' }} class="brandsection card">
                                                <div class="">
                                                    <a class="link text-decoration-none" href="/us/en/catalog/epoch" tabIndex="-1">
                                                        <div class="brand-image">
                                                            <div class="image-wrapper col-12 p-0 m-0 " sx={{ width: 'auto', height: '260px' }}>
                                                                <img
                                                        ...
                                                        <div class="p-0 w-100 brand-sec-body card-body">
                                                            <div class="head-3 heading-3 card-subtitle h6">Epoch</div>
                                                        </div>
                                                    </a>
                                                </div>
                                            </div>
                                    ...
                                    <div data-index="-3" tabIndex="-1" class="slick-slide slick-cloned" aria-hidden="true" sx={{ width: '261px' }}>
                                        <div>
                                            <div tabIndex="-1" sx={{ width: '100%', display: 'inline-block' }} class="brandsection card">
                                                <div class="">
                                                    <a class="link text-decoration-none" href="/us/en/catalog/sunright" tabIndex="-1">
                                                        <div class="brand-image">
                                                            <div class="image-wrapper col-12 p-0 m-0 " sx={{ width: 'auto', height: '260px' }}>
                                                                <img
                                                        ...
                                                        <div class="p-0 w-100 brand-sec-body card-body">
                                                            <div class="head-3 heading-3 card-subtitle h6">Sunright</div>
                                                        </div>
                                                    </a>
                                                </div>
                                            </div>
                                    ...
                                    <div data-index="-2" tabIndex="-1" class="slick-slide slick-cloned" aria-hidden="true" sx={{ width: '261px' }}>
                                        <div>
                                            <div tabIndex="-1" sx={{ width: '100%', display: 'inline-block' }} class="brandsection card">
                                                <div class="">
                                                    <a class="link text-decoration-none" href="/us/en/catalog/nu_colour" tabIndex="-1">
                                                        <div class="brand-image">
                                                            <div class="image-wrapper col-12 p-0 m-0 " sx={{ width: 'auto', height: '260px' }}>
                                                                <img
                                                        ...
                                                        <div class="p-0 w-100 brand-sec-body card-body">
                                                            <div class="head-3 heading-3 card-subtitle h6">Nu Colour</div>
                                                        </div>
                                                    </a>
                                                </div>
                                            </div>
                                    ...
                                    <div data-index="-1" tabIndex="-1" class="slick-slide slick-cloned" aria-hidden="true" sx={{ width: '261px' }}>
                                        <div>
                                            <div tabIndex="-1" sx={{ width: '100%', display: 'inline-block' }} class="brandsection card">
                                                <div class="">
                                                    <a class="link text-decoration-none" href="/us/en/catalog/180_system" tabIndex="-1">
                                                        <div class="brand-image">
                                                            <div class="image-wrapper col-12 p-0 m-0 " sx={{ width: 'auto', height: '260px' }}>
                                                                <img
                                                        ...
                                                        <div class="p-0 w-100 brand-sec-body card-body">
                                                            <div class="head-3 heading-3 card-subtitle h6">180 System</div>
                                                        </div>
                                                    </a>
                                                </div>
                                            </div>
                                    ...
                                    >
                                        <div>
                                            <div tabIndex="-1" sx={{ width: '100%', display: 'inline-block' }} class="brandsection card">
                                                <div class="">
                                                    <a class="link text-decoration-none" href="/us/en/catalog/ageloc">
                                                        <div class="brand-image">
                                                            <div class="image-wrapper col-12 p-0 m-0 " sx={{ width: 'auto', height: '260px' }}>
                                                                <img
                                                        ...
                                                        <div class="p-0 w-100 brand-sec-body card-body">
                                                            <div class="head-3 heading-3 card-subtitle h6">ageLOC</div>
                                                        </div>
                                                    </a>
                                                </div>
                                            </div>
                                    ...
                                    >
                                        <div>
                                            <div tabIndex="-1" sx={{ width: '100%', display: 'inline-block' }} class="brandsection card">
                                                <div class="">
                                                    <a class="link text-decoration-none" href="/us/en/catalog/renuspa_io">
                                                        <div class="brand-image">
                                                            <div class="image-wrapper col-12 p-0 m-0 " sx={{ width: 'auto', height: '260px' }}>
                                                                <img
                                                        ...
                                                        <div class="p-0 w-100 brand-sec-body card-body">
                                                            <div class="head-3 heading-3 card-subtitle h6">RenuSpa iO</div>
                                                        </div>
                                                    </a>
                                                </div>
                                            </div>
                                    ...
                                    >
                                        <div>
                                            <div tabIndex="-1" sx={{ width: '100%', display: 'inline-block' }} class="brandsection card">
                                                <div class="">
                                                    <a class="link text-decoration-none" href="/us/en/catalog/lumispa">
                                                        <div class="brand-image">
                                                            <div class="image-wrapper col-12 p-0 m-0 " sx={{ width: 'auto', height: '260px' }}>
                                                                <img
                                                        ...
                                                        <div class="p-0 w-100 brand-sec-body card-body">
                                                            <div class="head-3 heading-3 card-subtitle h6">ageLOC LumiSpa</div>
                                                        </div>
                                                    </a>
                                                </div>
                                            </div>
                                    ...
                                    >
                                        <div>
                                            <div tabIndex="-1" sx={{ width: '100%', display: 'inline-block' }} class="brandsection card">
                                                <div class="">
                                                    <a class="link text-decoration-none" href="/us/en/catalog/pharmanex">
                                                        <div class="brand-image">
                                                            <div class="image-wrapper col-12 p-0 m-0 " sx={{ width: 'auto', height: '260px' }}>
                                                                <img
                                                        ...
                                                        <div class="p-0 w-100 brand-sec-body card-body">
                                                            <div class="head-3 heading-3 card-subtitle h6">Pharmanex</div>
                                                        </div>
                                                    </a>
                                                </div>
                                            </div>
                                    ...
                                    >
                                        <div>
                                            <div tabIndex="-1" sx={{ width: '100%', display: 'inline-block' }} class="brandsection card">
                                                <div class="">
                                                    <a class="link text-decoration-none" href="/us/en/catalog/ap24">
                                                        <div class="brand-image">
                                                            <div class="image-wrapper col-12 p-0 m-0 " sx={{ width: 'auto', height: '260px' }}>
                                                                <img
                                                        ...
                                                        <div class="p-0 w-100 brand-sec-body card-body">
                                                            <div class="head-3 heading-3 card-subtitle h6">AP 24</div>
                                                        </div>
                                                    </a>
                                                </div>
                                            </div>
                                    ...
                                    <div data-index="5" class="slick-slide" tabIndex="-1" aria-hidden="true" sx={{ outline: 'none', width: '261px' }}>
                                        <div>
                                            <div tabIndex="-1" sx={{ width: '100%', display: 'inline-block' }} class="brandsection card">
                                                <div class="">
                                                    <a class="link text-decoration-none" href="/us/en/catalog/nutricentials" tabIndex="-1">
                                                        <div class="brand-image">
                                                            <div class="image-wrapper col-12 p-0 m-0 " sx={{ width: 'auto', height: '260px' }}>
                                                                <img
                                                                    src="https://media.nuskin.com/m/233bc4aad86697e8/Small-brand-nutricentials.jpg"
                                    ...
                                    <div data-index="10" tabIndex="-1" class="slick-slide slick-cloned" aria-hidden="true" sx={{ width: '261px' }}>
                                        <div>
                                            <div tabIndex="-1" sx={{ width: '100%', display: 'inline-block' }} class="brandsection card">
                                                <div class="">
                                                    <a class="link text-decoration-none" href="/us/en/catalog/ageloc" tabIndex="-1">
                                                        <div class="brand-image">
                                                            <div class="image-wrapper col-12 p-0 m-0 " sx={{ width: 'auto', height: '260px' }}>
                                                                <img
                                                                    src="https://media.nuskin.com/m/42911c8b05600476/Small-brand-ageloc-optweb.jpg"
                                    ...
                                    <div data-index="11" tabIndex="-1" class="slick-slide slick-cloned" aria-hidden="true" sx={{ width: '261px' }}>
                                        <div>
                                            <div tabIndex="-1" sx={{ width: '100%', display: 'inline-block' }} class="brandsection card">
                                                <div class="">
                                                    <a class="link text-decoration-none" href="/us/en/catalog/renuspa_io" tabIndex="-1">
                                                        <div class="brand-image">
                                                            <div class="image-wrapper col-12 p-0 m-0 " sx={{ width: 'auto', height: '260px' }}>
                                                                <img
                                                                    src="https://media.nuskin.com/transform/608744f0-243a-4f9f-afde-8af0158c1213/brand-nu-skin-renuspa-io"
                                    ...
                                    <div data-index="12" tabIndex="-1" class="slick-slide slick-cloned" aria-hidden="true" sx={{ width: '261px' }}>
                                        <div>
                                            <div tabIndex="-1" sx={{ width: '100%', display: 'inline-block' }} class="brandsection card">
                                                <div class="">
                                                    <a class="link text-decoration-none" href="/us/en/catalog/lumispa" tabIndex="-1">
                                                        <div class="brand-image">
                                                            <div class="image-wrapper col-12 p-0 m-0 " sx={{ width: 'auto', height: '260px' }}>
                                                                <img
                                                                    src="https://media.nuskin.com/m/3604b5202b0b64c6/Small-brand-lumispa-optweb.jpg"
                                    ...
                                    <div data-index="13" tabIndex="-1" class="slick-slide slick-cloned" aria-hidden="true" sx={{ width: '261px' }}>
                                        <div>
                                            <div tabIndex="-1" sx={{ width: '100%', display: 'inline-block' }} class="brandsection card">
                                                <div class="">
                                                    <a class="link text-decoration-none" href="/us/en/catalog/pharmanex" tabIndex="-1">
                                                        <div class="brand-image">
                                                            <div class="image-wrapper col-12 p-0 m-0 " sx={{ width: 'auto', height: '260px' }}>
                                                                <img
                                                                    src="https://media.nuskin.com/m/4a1245a63c595262/Small-brand-pharmanex-optweb.jpg"
                                    ...
                                    <div data-index="14" tabIndex="-1" class="slick-slide slick-cloned" aria-hidden="true" sx={{ width: '261px' }}>
                                        <div>
                                            <div tabIndex="-1" sx={{ width: '100%', display: 'inline-block' }} class="brandsection card">
                                                <div class="">
                                                    <a class="link text-decoration-none" href="/us/en/catalog/ap24" tabIndex="-1">
                                                        <div class="brand-image">
                                                            <div class="image-wrapper col-12 p-0 m-0 " sx={{ width: 'auto', height: '260px' }}>
                                                                <img
                                                                    src="https://media.nuskin.com/m/14a0fd6ef63e5dbb/Small-brand-ap_24.jpg"
                    ...
                    <div class="mob-view-all d-block d-md-none px-0 col">
                        <div class="">
                            <a class="link text-decoration-none mt-4" href="/us/en/categoryLanding/skin_and_beauty">
                                <h6 class="viewsec m-0 cta">View All</h6>
                            </a>
                        </div>
                    </div>
                ...
                <div class="separator-section w-100 p-0 container-fluid">
                    <div class="separator-container row">
                        <div class="hori-line"></div>
                        <h4 class="h4-bold subhead-l">WHO'S TALKING ABOUT US</h4>
                        <h3 class="heading-1">Featured In</h3>
                    </div>
                </div>
                <div class="featuredsec">
                    <div class="featured-container container">
                        <div class="slick-slider slick-initialized" dir="ltr">
                            <div class="slick-list">
                                <div class="slick-track" sx={{ opacity: 1, transform: 'translate3d(-1112px, 0px, 0px)', width: '6116px' }}>
                                    <div data-index="-4" tabIndex="-1" class="slick-slide slick-cloned" aria-hidden="true" sx={{ width: '278px' }}>
                                        <div>
                                            <div tabIndex="-1" sx={{ width: '100%', display: 'inline-block' }} class="featuredinsec card">
                                    ...
                                    <div data-index="-3" tabIndex="-1" class="slick-slide slick-cloned" aria-hidden="true" sx={{ width: '278px' }}>
                                        <div>
                                            <div tabIndex="-1" sx={{ width: '100%', display: 'inline-block' }} class="featuredinsec card">
                                                <div class="featured-box">
                                                    <div class="image-wrapper col-12 p-0 m-0 " sx={{ width: 'auto', height: 'auto' }}>
                                    ...
                                    <div data-index="-2" tabIndex="-1" class="slick-slide slick-cloned" aria-hidden="true" sx={{ width: '278px' }}>
                                        <div>
                                            <div tabIndex="-1" sx={{ width: '100%', display: 'inline-block' }} class="featuredinsec card">
                                                <div class="featured-box">
                                                    <div class="image-wrapper col-12 p-0 m-0 " sx={{ width: 'auto', height: 'auto' }}>
                                    ...
                                    <div data-index="-1" tabIndex="-1" class="slick-slide slick-cloned" aria-hidden="true" sx={{ width: '278px' }}>
                                        <div>
                                            <div tabIndex="-1" sx={{ width: '100%', display: 'inline-block' }} class="featuredinsec card">
                                                <div class="featured-box">
                                                    <div class="image-wrapper col-12 p-0 m-0 " sx={{ width: 'auto', height: 'auto' }}>
                                    ...
                                    <div data-index="4" class="slick-slide" tabIndex="-1" aria-hidden="true" sx={{ outline: 'none', width: '278px' }}>
                                        <div>
                                            <div tabIndex="-1" sx={{ width: '100%', display: 'inline-block' }} class="featuredinsec card">
                                                <div class="featured-box">
                                                    <div class="image-wrapper col-12 p-0 m-0 " sx={{ width: 'auto', height: 'auto' }}>
                                    ...
                                    <div data-index="5" class="slick-slide" tabIndex="-1" aria-hidden="true" sx={{ outline: 'none', width: '278px' }}>
                                        <div>
                                            <div tabIndex="-1" sx={{ width: '100%', display: 'inline-block' }} class="featuredinsec card">
                                                <div class="featured-box">
                                                    <div class="image-wrapper col-12 p-0 m-0 " sx={{ width: 'auto', height: 'auto' }}>
                                    ...
                                    <div data-index="6" class="slick-slide" tabIndex="-1" aria-hidden="true" sx={{ outline: 'none', width: '278px' }}>
                                        <div>
                                            <div tabIndex="-1" sx={{ width: '100%', display: 'inline-block' }} class="featuredinsec card">
                                                <div class="featured-box">
                                                    <div class="image-wrapper col-12 p-0 m-0 " sx={{ width: 'auto', height: 'auto' }}>
                                    ...
                                    <div data-index="7" class="slick-slide" tabIndex="-1" aria-hidden="true" sx={{ outline: 'none', width: '278px' }}>
                                        <div>
                                            <div tabIndex="-1" sx={{ width: '100%', display: 'inline-block' }} class="featuredinsec card">
                                                <div class="featured-box">
                                                    <div class="image-wrapper col-12 p-0 m-0 " sx={{ width: 'auto', height: 'auto' }}>
                                    ...
                                    <div data-index="8" class="slick-slide" tabIndex="-1" aria-hidden="true" sx={{ outline: 'none', width: '278px' }}>
                                        <div>
                                            <div tabIndex="-1" sx={{ width: '100%', display: 'inline-block' }} class="featuredinsec card">
                                                <div class="featured-box">
                                                    <div class="image-wrapper col-12 p-0 m-0 " sx={{ width: 'auto', height: 'auto' }}>
                                    ...
                                    <div data-index="9" tabIndex="-1" class="slick-slide slick-cloned" aria-hidden="true" sx={{ width: '278px' }}>
                                        <div>
                                            <div tabIndex="-1" sx={{ width: '100%', display: 'inline-block' }} class="featuredinsec card">
                                                <div class="featured-box">
                                                    <div class="image-wrapper col-12 p-0 m-0 " sx={{ width: 'auto', height: 'auto' }}>
                                    ...
                                    <div data-index="10" tabIndex="-1" class="slick-slide slick-cloned" aria-hidden="true" sx={{ width: '278px' }}>
                                        <div>
                                            <div tabIndex="-1" sx={{ width: '100%', display: 'inline-block' }} class="featuredinsec card">
                                                <div class="featured-box">
                                                    <div class="image-wrapper col-12 p-0 m-0 " sx={{ width: 'auto', height: 'auto' }}>
                                    ...
                                    <div data-index="11" tabIndex="-1" class="slick-slide slick-cloned" aria-hidden="true" sx={{ width: '278px' }}>
                                        <div>
                                            <div tabIndex="-1" sx={{ width: '100%', display: 'inline-block' }} class="featuredinsec card">
                                                <div class="featured-box">
                                                    <div class="image-wrapper col-12 p-0 m-0 " sx={{ width: 'auto', height: 'auto' }}>
                                    ...
                                    <div data-index="12" tabIndex="-1" class="slick-slide slick-cloned" aria-hidden="true" sx={{ width: '278px' }}>
                                        <div>
                                            <div tabIndex="-1" sx={{ width: '100%', display: 'inline-block' }} class="featuredinsec card">
                                                <div class="featured-box">
                                                    <div class="image-wrapper col-12 p-0 m-0 " sx={{ width: 'auto', height: 'auto' }}>
                                    ...
                                    <div data-index="13" tabIndex="-1" class="slick-slide slick-cloned" aria-hidden="true" sx={{ width: '278px' }}>
                                        <div>
                                            <div tabIndex="-1" sx={{ width: '100%', display: 'inline-block' }} class="featuredinsec card">
                                                <div class="featured-box">
                                                    <div class="image-wrapper col-12 p-0 m-0 " sx={{ width: 'auto', height: 'auto' }}>
                                    ...
                                    <div data-index="14" tabIndex="-1" class="slick-slide slick-cloned" aria-hidden="true" sx={{ width: '278px' }}>
                                        <div>
                                            <div tabIndex="-1" sx={{ width: '100%', display: 'inline-block' }} class="featuredinsec card">
                                                <div class="featured-box">
                                                    <div class="image-wrapper col-12 p-0 m-0 " sx={{ width: 'auto', height: 'auto' }}>
                                    ...
                                    <div data-index="15" tabIndex="-1" class="slick-slide slick-cloned" aria-hidden="true" sx={{ width: '278px' }}>
                                        <div>
                                            <div tabIndex="-1" sx={{ width: '100%', display: 'inline-block' }} class="featuredinsec card">
                                                <div class="featured-box">
                                                    <div class="image-wrapper col-12 p-0 m-0 " sx={{ width: 'auto', height: 'auto' }}>
                                    ...
                                    <div data-index="16" tabIndex="-1" class="slick-slide slick-cloned" aria-hidden="true" sx={{ width: '278px' }}>
                                        <div>
                                            <div tabIndex="-1" sx={{ width: '100%', display: 'inline-block' }} class="featuredinsec card">
                                                <div class="featured-box">
                                                    <div class="image-wrapper col-12 p-0 m-0 " sx={{ width: 'auto', height: 'auto' }}>
                                    ...
                                    <div data-index="17" tabIndex="-1" class="slick-slide slick-cloned" aria-hidden="true" sx={{ width: '278px' }}>
                                        <div>
                                            <div tabIndex="-1" sx={{ width: '100%', display: 'inline-block' }} class="featuredinsec card">
                                                <div class="featured-box">
                                                    <div class="image-wrapper col-12 p-0 m-0 " sx={{ width: 'auto', height: 'auto' }}>
                ...
                <div class="container">
                    <div class="mx-0 row">
                        <div
                            ...
                            class="tagline mx-auto text-center taglineImgBackground p-0 col"
                        >
                            <div class="tagline-textcontainer">
                                <strong>
                                    <p class="tagline-title">It's Official!</p>
                                </strong>
                                <p class="paragraph-l text-uppercase">We're your go-to for devices that help you and feel your best!</p>
                                <p class="tagline-text2"></p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="separator-section w-100 p-0 container-fluid">
                    <div class="separator-container row">
                        <div class="hori-line"></div>
                        <h4 class="h4-bold subhead-l">OUR CORE</h4>
                        <h3 class="heading-1">The Nu Skin Way</h3>
                    </div>
                </div>
                <div class=" position-relative w-100 info-block-section d-flex">
                    <div class="container">
                        <div class="info-section d-lg-flex justify-content-between row">
                            <div class="p-0 mb-2 mb-lg-0 d-inline-block col-lg-5">
                                <h2 class="heading-1">
                                    Nu Skin,
                                    <br />
                            ...
                            <div class="p-0 col-lg-7">
                                <ul class="d-flex p-0 m-0 mb-md-0 d-inline-block">
                                    <li data-testid="infobar-item-0" class="nohover">
                                        <div class="">
                                            <a href="/" class="link " target="_blank" data-testid="link" tabIndex="-1">
                                                <h2 class="heading-1">
                                                    <span>
                                                        <span>25</span>
                                                    </span>
                                                ...
                                                <h5 class="h5-medium"> Years of Giving</h5>
                                            </a>
                                        </div>
                                    </li>
                                    <li data-testid="infobar-item-1" class="hover">
                                        <div class="">
                                            <a href="/content/globalffg/home.html" class="link " target="_blank" data-testid="link" tabIndex="0">
                                                <h2 class="heading-1">
                                                    <span>
                                                        <span>20</span>
                                                    </span>
                                                ...
                                                <h5 class="h5-medium"> Current Social Projects</h5>
                                            </a>
                                        </div>
                                    </li>
                                    <li data-testid="infobar-item-2" class="hover">
                                        <div class="">
                                            <a
                                            ...
                                            >
                                                ...
                                                <h5 class="h5-medium"> Meals Donated through Nourish the Children</h5>
                                            </a>
                                        </div>
                                    </li>
                                </ul>
                ...
                <div class="highlight-section container-fluid">
                    <div class="highlight-section-1 row">
                        <div class="highlight-image px-0 col">
                            <div class="image-wrapper col-12 p-0 m-0 " sx={{ width: 'auto', height: 'auto' }}>
                                <img
                        ...
                        <div class="highlight-section-content col">
                            <h2 class="heading-2">Being a Force for Good</h2>
                            <p class="paragraph-m pb-1">
                            ...
                            <div class="">
                                <a href="/content/globalffg/home.html" class="link paragraph-m" target="_blank">
                ...
                <div class="highlight-section-two container-fluid">
                    <div class="highlight-section-2 row">
                        <div class="highlight-image px-0 col">
                            <div class="image-wrapper col-12 p-0 m-0 " sx={{ width: 'auto', height: 'auto' }}>
                                <img
                        ...
                        <div class="highlight-section-two-content col">
                            <h2 class="heading-2">Nature + Science</h2>
                            <p class="paragraph-m pb-1">
                                Capturing the best in nature to bring you the best results is our personal mission. We combine powerful ingredients with
                                innovative science and technology. The result? World-class products that deliver real benefits. And even though we’ve spent more
                                than 30 years researching aging at the genetic level, Mother Nature continually inspires us to push the boundaries of inquiry
                                and innovation. We bottle what’s best and bring it right to your door.
                            </p>
                            <div class="">
                                <a href="/content/nuskin/en_US/topnav-skin-and-beauty/science.html" class="link paragraph-m" target="_blank">
                ...
                <div class="awardssec">
                    <div class="container">
                        <div>
                            <div class="w-100 justify-content-center p-0 m-0 row">
